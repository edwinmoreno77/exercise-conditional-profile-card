...
function render(variables = {}) {
  ...
  document.querySelector(
    "#widget_content"
  ).innerHTML = `<div class="widget">${cover}<img src="${variables.avatarURL}" class="photo" />
          ...
          <ul class="${variables.socialMediaPosition? variables.socialMediaPosition: "position-right"}">
            ...
            <li><a href="https://linkedin.com/${variables.linkedin ? "in/" + variables.linkedin: "school/4geeksacademy"}"><i class="fab fa-linkedin"></i></a></li>
